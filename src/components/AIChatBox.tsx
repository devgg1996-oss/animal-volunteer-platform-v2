...
/**
 * Tool part shape for custom rendering (avoids UIMessagePart generic args).
 */
export type ToolPartLike = { type: `tool-${string}`; state?: string; input?: unknown; output?: unknown; error?: string };

/**
 * Tool invocation state (matches AI SDK UIToolInvocation state).
 */
